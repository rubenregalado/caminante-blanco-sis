          ...
          {cargando ? (
            ...
            <>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                ...
                <div className="hidden lg:grid grid-cols-[1fr_1.4fr_1fr_1fr_0.8fr_0.8fr_0.8fr] gap-3 px-4 py-3 border-b border-gray-100 text-xs font-semibold text-gray-400 uppercase tracking-wide">
                  <span># Orden</span>
                  <span>Cliente</span>
                  <span>Ingreso</span>
                  <span>Entrega</span>
                ...
                {ordenes.map((orden, idx) => {
                  ...
                  const fechaEntregaReal = orden.fechaEntregado
                  ...
                  return (
                    ...
                    >
                      {/* Vista escritorio */}
                      <div className="hidden lg:grid grid-cols-[1fr_1.4fr_1fr_1fr_0.8fr_0.8fr_0.8fr] gap-3 px-4 py-3 items-center">
                        ...
                        <div className="text-sm">
                          {orden.estado === 'entregado' && fechaEntregaReal ? (
                            <span className="text-green-700 font-medium">{formatearFecha(fechaEntregaReal)}</span>
                          ) : orden.fechaEntrega ? (
                            <span className="text-gray-500">{formatearFecha(orden.fechaEntrega)}</span>
                          ) : (
                      ...
                      <div className="lg:hidden px-4 py-3 flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex gap-3 mt-1 text-xs text-gray-400">
                            ...
                            {orden.estado === 'entregado' && fechaEntregaReal && (
                              <span className="text-green-600">Entregado: {formatearFecha(fechaEntregaReal)}</span>
                            )}
                          </div>
                        </div>
